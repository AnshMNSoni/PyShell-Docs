  ...
  const testimonials = [
    {
      ...
      content:
        "PyShell has completely transformed my development workflow. The Git integration and voice commands save me hours every week.",
      avatar: "AJ",
    },
    {
      name: "Sarah Chen",
      ...
      content:
        "The process synchronization feature in PyShell is a game-changer for my system management tasks. Highly recommended!",
      avatar: "SC",
    },
    {
      ...
      content:
        "I love how PyShell combines traditional terminal functionality with modern features. The calculator with calculus support is amazing.",
      avatar: "MR",
    },
  ]
        ...
        <div className="flex flex-col items-center justify-center space-y-4 text-center">
          <div className="space-y-2">
            ...
            <p className="max-w-[700px] text-muted-foreground text-sm sm:text-base md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              Hear from developers who have transformed their terminal experience with PyShell.
            </p>
          </div>
        </div>
