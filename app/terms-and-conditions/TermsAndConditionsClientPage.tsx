...
import { ArrowLeft, ArrowUp, Printer, Clock } from "lucide-react"
...
export default function TermsAndConditionsClientPage() {
  const sections = [
    ...
    { id: "us-legal", title: "United States Legal Compliance" },
      ...
      <div className="space-y-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <h1 className="scroll-m-20 text-4xl font-bold tracking-tight">Terms and Conditions</h1>
        ...
        <div className="rounded-lg border p-6 bg-muted/30">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">
            {sections.map((section) => (
              <li key={section.id}>
                <a href={`#${section.id}`} className="text-primary hover:underline flex items-center gap-1">
        ...
        <div className="prose prose-sm sm:prose dark:prose-invert max-w-none">
          ...
          <section id="interpretation">
            ...
            <h3 className="scroll-m-20 text-xl font-semibold tracking-tight">Interpretation</h3>
            <p>
            ...
            <h3 className="scroll-m-20 text-xl font-semibold tracking-tight">Definitions</h3>
            ...
            <ul>
              ...
              <li>
                <strong>Terms and Conditions</strong> (also referred to as "Terms") mean these Terms and Conditions that
                form the entire agreement between You and the Company regarding the use of the Service. This Terms and
                Conditions agreement has been created with the help of the Terms and Conditions Generator.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to PyShell | Docs, accessible from{" "}
          ...
          <section id="acknowledgment">
            <h2 className="scroll-m-20 border-b pb-2 text-2xl font-semibold tracking-tight">Acknowledgment</h2>
          ...
          <section id="links">
            <h2 className="scroll-m-20 border-b pb-2 text-2xl font-semibold tracking-tight">Links to Other Websites</h2>
            <p>
          ...
          <section id="termination">
            <h2 className="scroll-m-20 border-b pb-2 text-2xl font-semibold tracking-tight">Termination</h2>
            <p>
          ...
          <section id="limitation">
            <h2 className="scroll-m-20 border-b pb-2 text-2xl font-semibold tracking-tight">Limitation of Liability</h2>
            <p>
          ...
          <section id="governing-law">
            <h2 className="scroll-m-20 border-b pb-2 text-2xl font-semibold tracking-tight">Governing Law</h2>
            <p>
          ...
          <section id="disputes">
            <h2 className="scroll-m-20 border-b pb-2 text-2xl font-semibold tracking-tight">Disputes Resolution</h2>
            <p>
          ...
          <section id="severability">
            <h2 className="scroll-m-20 border-b pb-2 text-2xl font-semibold tracking-tight">Severability and Waiver</h2>
            <h3 className="scroll-m-20 text-xl font-semibold tracking-tight">Severability</h3>
            <p>
            ...
            <h3 className="scroll-m-20 text-xl font-semibold tracking-tight">Waiver</h3>
            <p>
          ...
          <section id="contact">
            <h2 className="scroll-m-20 border-b pb-2 text-2xl font-semibold tracking-tight">Contact Us</h2>
            ...
            <p className="text-sm text-muted-foreground mt-8">Generated using TermsFeed Privacy Policy Generator</p>
          </section>
        </div>
