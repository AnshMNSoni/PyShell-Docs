...
import { ArrowLeft, ArrowUp, Printer, Clock, Shield, Eye, Lock, FileText, Users, Globe, Trash2, AlertTriangle, Link2 } from "lucide-react"
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-4">
              {/* Header Card */}
              <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-6 shadow-lg">
                <div className="flex items-center gap-3 mb-4">
                  <div className="p-2 rounded-lg" style={{ backgroundColor: '#22c55e20' }}>
                    <Shield className="h-5 w-5" style={{ color: '#22c55e' }} />
                  </div>
                  <div>
                    <h3 className="font-semibold text-lg text-white">Privacy Policy</h3>
                    <Badge variant="outline" className="mt-1 flex items-center gap-1 w-fit border-gray-700 text-gray-300">
                ...
                <div className="flex gap-2">
                  <Button variant="outline" size="sm" onClick={() => window.print()} className="flex-1 flex items-center gap-2 border-gray-700 text-gray-300 hover:bg-gray-800">
                    <Printer className="h-4 w-4" />
                    Print
                  </Button>
                  <Button variant="outline" size="sm" className="flex-1 border-gray-700 text-gray-300 hover:bg-gray-800" onClick={() => window.history.back()}>
              ...
              {/* Navigation */}
              <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-4 shadow-lg">
                <h4 className="font-semibold mb-4 text-sm uppercase tracking-wide text-gray-400">Contents</h4>
                <nav className="space-y-1">
                  {sections.map((section) => {
                    ...
                    return (
                      ...
                      >
                        <Icon className={`h-4 w-4 transition-colors ${isActive ? '' : 'group-hover:text-white'}`} 
          ...
          <div className="lg:col-span-3">
            <div className="space-y-8">
              ...
              <div className="text-center space-y-6 py-12">
                <div className="inline-flex items-center justify-center p-4 rounded-2xl mb-6" style={{ backgroundColor: '#22c55e20' }}>
              ...
              <div className="space-y-12">
                <section id="introduction" className="group">
                  <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start gap-4 mb-6">
                      <div className="p-3 rounded-xl bg-blue-500/10 flex-shrink-0">
                        <FileText className="h-6 w-6 text-blue-400" />
                      </div>
                      <div>
                        <h2 className="scroll-m-20 text-3xl font-bold tracking-tight mb-2 text-white">Introduction</h2>
                        <div className="w-16 h-1 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full" />
                      </div>
                    </div>
                    <div className="prose prose-gray max-w-none space-y-4 text-gray-300 leading-relaxed">
                      <p>
                ...
                <section id="interpretation" className="group">
                  <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h2 className="scroll-m-20 text-3xl font-bold tracking-tight mb-2 text-white">Interpretation and Definitions</h2>
                        <div className="w-16 h-1 bg-gradient-to-r from-green-500 to-blue-500 rounded-full" />
                      </div>
                    </div>
                    <div className="prose prose-gray max-w-none space-y-6 text-gray-300 leading-relaxed">
                      <div>
                        <h3 className="text-xl font-semibold mb-3 text-white">Interpretation</h3>
                        <p>
                      ...
                      <div>
                        ...
                        <div className="grid gap-4">
                          {[
                            ...
                            <div key={index} className="p-4 rounded-lg bg-gray-800/50 border-l-4" style={{ borderLeftColor: '#22c55e' }}>
                              <div className="flex items-start gap-3">
                                <span className="font-semibold text-sm" style={{ color: '#22c55e' }}>{item.term}:</span>
                                <span className="text-sm text-gray-300">{item.definition}</span>
                              </div>
                            </div>
                          ))}
                          <div className="p-4 rounded-lg bg-gray-800/50 border-l-4" style={{ borderLeftColor: '#22c55e' }}>
                            <div className="flex items-start gap-3">
                              <span className="font-semibold text-sm" style={{ color: '#22c55e' }}>Website:</span>
                              <span className="text-sm text-gray-300">
                                refers to PyShell | Docs, accessible from{" "}
                                <a href="https://pyshelldocs.netlify.app/" className="hover:underline" style={{ color: '#22c55e' }}>
                ...
                <section id="collecting-data" className="group">
                  <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h2 className="scroll-m-20 text-3xl font-bold tracking-tight mb-2 text-white">Collecting and Using Your Personal Data</h2>
                        <div className="w-16 h-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full" />
                      </div>
                    </div>
                    <div className="prose prose-gray max-w-none space-y-6 text-gray-300 leading-relaxed">
                      <div>
                        <h3 className="text-xl font-semibold mb-3 text-white">Types of Data Collected</h3>
                        ...
                        <div className="space-y-6">
                          <div>
                            ...
                            <div className="p-3 rounded-lg bg-gray-800/50 border-l-4" style={{ borderLeftColor: '#22c55e' }}>
                              <span className="text-sm font-medium text-gray-300">Usage Data</span>
                            </div>
                          </div>
                      ...
                      <div>
                        <h3 className="text-xl font-semibold mb-4 text-white">Tracking Technologies and Cookies</h3>
                        <p className="mb-4">
                        ...
                        <div className="space-y-3 mb-6">
                          <div className="p-4 rounded-lg bg-orange-900/20 border-l-4 border-orange-500">
                            ...
                            Your browser setting so that it will refuse Cookies, our Service may use Cookies.</p>
                          </div>
                        ...
                        <div className="space-y-4">
                          <div className="p-4 rounded-lg bg-red-900/20 border border-red-800">
                            <h5 className="font-semibold text-red-300 mb-2">Necessary / Essential Cookies</h5>
                            <div className="space-y-1 text-sm">
                              <p><span className="font-medium">Type:</span> Session Cookies</p>
                              <p><span className="font-medium">Administered by:</span> Us</p>
                              <p><span className="font-medium">Purpose:</span> These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p>
                            </div>
                          </div>

                          <div className="p-4 rounded-lg bg-yellow-900/20 border border-yellow-800">
                            <h5 className="font-semibold text-yellow-300 mb-2">Cookies Policy / Notice Acceptance Cookies</h5>
                            <div className="space-y-1 text-sm">
                              <p><span className="font-medium">Type:</span> Persistent Cookies</p>
                              <p><span className="font-medium">Administered by:</span> Us</p>
                              <p><span className="font-medium">Purpose:</span> These Cookies identify if users have accepted the use of cookies on the Website.</p>
                            </div>
                          </div>

                          <div className="p-4 rounded-lg bg-indigo-900/20 border border-indigo-800">
                            <h5 className="font-semibold text-indigo-300 mb-2">Functionality Cookies</h5>
                            <div className="space-y-1 text-sm">
                              <p><span className="font-medium">Type:</span> Persistent Cookies</p>
                              <p><span className="font-medium">Administered by:</span> Us</p>
                              <p><span className="font-medium">Purpose:</span> These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          {[
                            ...
                            <div key={index} className="p-3 rounded-lg bg-gray-800/50 border-l-4" style={{ borderLeftColor: '#22c55e' }}>
                              <p><strong style={{ color: '#22c55e' }}>{item.title}:</strong> <span className="text-gray-300">{item.desc}</span></p>
                            </div>
                          ))}
                        </div>

                        <p className="mt-6 mb-4">We may share Your personal information in the following situations:</p>
                        <div className="space-y-3">
                          {[
                            ...
                            <div key={index} className="p-3 rounded-lg bg-amber-900/20 border-l-4 border-amber-500">
                              <p><strong className="text-amber-300">{item.title}:</strong> <span className="text-gray-300">{item.desc}</span></p>
                            </div>
                          ))}
                        </div>
                      </div>
                ...
                <section id="data-retention" className="group">
                  <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h2 className="scroll-m-20 text-3xl font-bold tracking-tight mb-2 text-white">Retention of Your Personal Data</h2>
                ...
                <section id="data-transfer" className="group">
                  <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h2 className="scroll-m-20 text-3xl font-bold tracking-tight mb-2 text-white">Transfer of Your Personal Data</h2>
                ...
                <section id="delete-data" className="group">
                  <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h2 className="scroll-m-20 text-3xl font-bold tracking-tight mb-2 text-white">Delete Your Personal Data</h2>
                ...
                <section id="disclosure" className="group">
                  <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h2 className="scroll-m-20 text-3xl font-bold tracking-tight mb-2 text-white">Disclosure of Your Personal Data</h2>
                        <div className="w-16 h-1 bg-gradient-to-r from-orange-500 to-red-500 rounded-full" />
                      </div>
                    </div>
                    <div className="prose prose-gray max-w-none space-y-6 text-gray-300 leading-relaxed">
                      <div>
                        <h3 className="text-xl font-semibold mb-3 text-white">Business Transactions</h3>
                        <p>
                      ...
                      <div>
                        <h3 className="text-xl font-semibold mb-3 text-white">Law enforcement</h3>
                        <p>
                      ...
                      <div>
                        <h3 className="text-xl font-semibold mb-3 text-white">Other legal requirements</h3>
                        <p className="mb-3">
                        ...
                        <div className="space-y-2">
                          {[
                            ...
                            <div key={index} className="p-3 rounded-lg bg-orange-900/20 border-l-4 border-orange-500">
                ...
                <section id="security" className="group">
                  <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h2 className="scroll-m-20 text-3xl font-bold tracking-tight mb-2 text-white">Security of Your Personal Data</h2>
                ...
                <section id="childrens-privacy" className="group">
                  <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h2 className="scroll-m-20 text-3xl font-bold tracking-tight mb-2 text-white">Children's Privacy</h2>
                ...
                <section id="links" className="group">
                  <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h2 className="scroll-m-20 text-3xl font-bold tracking-tight mb-2 text-white">Links to Other Websites</h2>
                ...
                <section id="changes" className="group">
                  <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h2 className="scroll-m-20 text-3xl font-bold tracking-tight mb-2 text-white">Changes to this Privacy Policy</h2>
                        <div className="w-16 h-1 bg-gradient-to-r from-violet-500 to-purple-500 rounded-full" />
                      </div>
                    </div>
                    <div className="prose prose-gray max-w-none space-y-4 text-gray-300 leading-relaxed">
                      <p>
                ...
                <section id="contact" className="group">
                  <div className="rounded-2xl border border-gray-800 bg-gray-900/80 backdrop-blur-sm p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                    <div className="flex items-start gap-4 mb-6">
                      ...
                      <div>
                        <h2 className="scroll-m-20 text-3xl font-bold tracking-tight mb-2 text-white">Contact Us</h2>
                    ...
                    <div className="prose prose-gray max-w-none space-y-4 text-gray-300 leading-relaxed">
                      ...
                      <div className="p-4 rounded-lg bg-gray-800/50 border-l-4" style={{ borderLeftColor: '#22c55e' }}>
                        <p className="text-sm">
                          ...
                          <a href="mailto:developers.pyshell@gmail.com" className="hover:underline font-medium" style={{ color: '#22c55e' }}>
              ...
              <div className="flex justify-between items-center mt-12 pt-8 border-t border-gray-700">
                <button 
                  ...
                  className="flex items-center gap-2 bg-none border-none cursor-pointer transition-colors duration-200 text-gray-400 hover:text-white"
                >
                  <ArrowLeft className="h-4 w-4" />
                  Back to Home
                </button>
