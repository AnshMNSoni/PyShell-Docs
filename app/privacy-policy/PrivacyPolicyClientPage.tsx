      ...
      <div className="space-y-8">
        ...
        <div className="prose prose-sm sm:prose dark:prose-invert max-w-none">
          ...
          <section id="collecting-data">
            ...
            <h3 className="scroll-m-20 text-xl font-semibold tracking-tight">Types of Data Collected</h3>
            <h4 className="scroll-m-20 text-lg font-semibold tracking-tight">Personal Data</h4>
            <p>
            ...
            <h4 className="scroll-m-20 text-lg font-semibold tracking-tight">Usage Data</h4>
            ...
            <h3 className="scroll-m-20 text-xl font-semibold tracking-tight">Tracking Technologies and Cookies</h3>
            <p>
            ...
            <h3 className="scroll-m-20 text-xl font-semibold tracking-tight">Use of Your Personal Data</h3>
          ...
          <section id="disclosure">
            ...
            <h3 className="scroll-m-20 text-xl font-semibold tracking-tight">Business Transactions</h3>
            <p>
            ...
            <h3 className="scroll-m-20 text-xl font-semibold tracking-tight">Law enforcement</h3>
            <p>
            ...
            <h3 className="scroll-m-20 text-xl font-semibold tracking-tight">Other legal requirements</h3>
            <p>
          ...
          <section id="childrens-privacy">
            <h2 className="scroll-m-20 border-b pb-2 text-2xl font-semibold tracking-tight">Children's Privacy</h2>
            <p>
